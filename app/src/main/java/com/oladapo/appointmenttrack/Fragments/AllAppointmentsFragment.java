...
public class AllAppointmentsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final TextView noAppointmentsTextView = view.findViewById(R.id.no_appointmentsAll);
        coordinatorLayout = view.findViewById(R.id.allAppointmentsLayout);

        final AppointmentAdapter adapter = new AppointmentAdapter();

        RecyclerView recyclerView = view.findViewById(R.id.allAppointmentsRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setHasFixedSize(true);

        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new AllAppointmentsFragment.SwipeToDeleteCallback(adapter));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_EDIT_APPOINTMENT && resultCode == 2) {
